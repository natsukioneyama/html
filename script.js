...
document.addEventListener("DOMContentLoaded", function() {
  ...
  var slides = [
    ...
    { type: "image", src: "img/Replica man/ss24/03.jpg", caption: "REPLICA MAN SS24 / PAVEL GOLIK / ANDREJ SKOK" },
    ...
    { type: "image", src: "img/Replica man/ss24/19.jpg", caption: "REPLICA MAN SS24 / PAVEL GOLIK / ANDREJ SKOK" },
    ...
    { type: "image", src: "img/numeroswitzerland/Issue01–02/07.jpg", caption: "NUMERO SWITZERLAND" },
    ...
    { type: "image", src: "img/numeroswitzerland/Issue01-01/10.jpg", caption: "NUMERO SWITZERLAND" },
    ...
    { type: "image", src: "img/numeroswitzerlandhomme/Issue01/09.jpg", caption: "NUMERO SWITZERLAND" },
    ...
    { type: "image", src: "img/Untitled_/01/14.jpg", caption: "UNTITLED X LUCIE ROX" },
    { type: "image", src: "img/Untitled_/01/15.jpg", caption: "UNTITLED X LUCIE ROX" },
    { type: "image", src: "img/crash/103/12.jpg", caption: "CRASH X MANUEL OBADIA-WILLS" },
    { type: "image", src: "img/crash/103/09.jpg", caption: "CRASH X MANUEL OBADIA-WILLS" },
    ...
    { type: "image", src: "img/nicotine/Issue7/02.jpg", caption: "NICOTINE MAGAZINE ISSUE 7 / FERNANDO UCEDA" },
  ...
  if (window.innerWidth > 768) {
    slideshowContainer.addEventListener("mousemove", function(e) {
      ...
      if (x < rect.width / 2) {
        // 左半分：カスタム左矢印カーソル
        slideshowContainer.style.cursor = "url('img/site/left01.png'), auto";
      } else {
        // 右半分：カスタム右矢印カーソル
        slideshowContainer.style.cursor = "url('img/site/right01.png'), auto";
      }
    });
  }
